...
- Thanks to the power of [pure proxies](../learn/accounts/learn-proxies-pure.md), adding and removing signatories or adjusting the threshold is now possible without creating new multisigs and Multix provides an intuitive interface to work with pure proxies.

The pure proxy setup used by [MultiX](https://github.com/ChainSafe/Multix) can be seen on the
[pure proxy page](../learn/accounts/learn-proxies-pure.md#why-pure-proxy).
