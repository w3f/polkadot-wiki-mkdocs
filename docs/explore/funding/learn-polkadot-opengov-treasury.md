...
[transaction fees](../../learn/basics/learn-transactions.md#transaction-fees), [slashing](../../learn/basics/learn-offenses.md), and
[staking inefficiencies](../../learn/basics/token-and-assets/learn-inflation.md). Treasury funds are held in a
[system account](../../learn/advanced/learn-account-advanced.md#system-accounts) that cannot be controlled by any
...
!!!tip "Creating a Treasury Proposal on Polkadot OpenGov"
    ...
    outlined on [this how-to guide](../../learn/advanced/polkadot-js/polkadot-js-guides/learn-guides-treasury.md#creating-a-treasury-proposal).
...
- **Slashes:** whenever validators and nominators are [slashed](../../learn/basics/learn-offenses.md), a share of the slashed tokens are diverted to Treasury. They are typically rare and unpredictable events.
...
- **Treasury proposals & Bounties:** they make up the largest share of outflow tokens to the
  ...
  [spend period](../../learn/general/glossary.md#spend-period).
- **Tips:** smaller payouts directly to grantees that can happen within a
  [spend period](../../learn/general/glossary.md#spend-period).

!!!info "Spend Period Schedule"
    On Polkadot-JS UI, navigate to Governance > Treasury to view the status of current [spend period](../../learn/general/glossary.md#spend-period).
...
[origin and track parameters](../../learn/basics/polkadot-opengov/learn-polkadot-opengov-origins.md#origins-and-tracks-info).

- [Treasurer](../../learn/basics/polkadot-opengov/learn-polkadot-opengov-origins.md#treasurer)
- [Big Spender](../../learn/basics/polkadot-opengov/learn-polkadot-opengov-origins.md#big-spender)
- [Medium Spender](../../learn/basics/polkadot-opengov/learn-polkadot-opengov-origins.md#medium-spender)
- [Small Spender](../../learn/basics/polkadot-opengov/learn-polkadot-opengov-origins.md#small-spender)
- [Big Tipper](../../learn/basics/polkadot-opengov/learn-polkadot-opengov-origins.md#big-tipper)
- [Small Tipper](../../learn/basics/polkadot-opengov/learn-polkadot-opengov-origins.md#small-tipper)
...
[Polkassembly](../apps/governance-apps.md).
...
[collective](../../learn/advanced/architecture/parachains/learn-system-chains.md#collectives) is also possible.

Rather than have many referenda through OpenGov, the treasury can allocate funds to each
sub-treasury (through [governance](../../learn/basics/polkadot-opengov/learn-polkadot-opengov.md)), from which each respective collective
can spend funds (depending on their specific rule set).

New treasuries could be added to respective
[system chains](../../learn/advanced/architecture/parachains/learn-system-chains.md#existing-system-chains) through governance by adding more
...
[multi-signature account](../../learn/basics/accounts/learn-account-multisig.md). Bounties can access a large amount of funds,
...
A proposer can [submit a bounty proposal](../../learn/advanced/polkadot-js/polkadot-js-guides/learn-guides-bounties.md#submit-a-bounty-proposal) to
OpenGov,
[with a curator to be defined later](../../learn/advanced/polkadot-js/polkadot-js-guides/learn-guides-bounties.md#assign-a-curator-to-a-bounty), whose
...
!!!info "Polkadot-JS Guides"
    If you are an advanced user, see the [Polkadot-JS guides about bounties](../../learn/advanced/polkadot-js/polkadot-js-guides/learn-guides-bounties.md) and [treasury](../../learn/advanced/polkadot-js/polkadot-js-guides/learn-guides-treasury.md).
