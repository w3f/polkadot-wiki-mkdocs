...
[**proxy accounts**](../../learn/basics/accounts/learn-proxies.md) and you can import your
[staking proxy](../../learn/advanced/learn-staking-advanced.md#staking-proxies) (for nominators) or
[non-transfer proxy](../../learn/basics/accounts/learn-proxies.md#proxy-types) (for nomination pool admins and members).
...
[Metadata updates](../../learn/advanced/polkadot-js/polkadot-js-guides/learn-guides-transfers.md#metadata-updates-with-the-polkadot-js-browser-extension)
...
On top of the [existential deposit](../../learn/basics/accounts/index.md#existential-deposit-and-reaping), you
need some free balance to pay for
[transaction fees](../../learn/basics/learn-transactions.md#transaction-fees) and
...
[advanced staking page](../../learn/advanced/learn-staking-advanced.md).
...
to [staking](../learn/learn-staking.md) on Polkadot, [Kusama](../../learn/comparisons/learn-comparisons-kusama.md)
(Polkadot's canary network) and [Westend](../../learn/basics/token-and-assets/learn-DOT.md#getting-tokens-on-the-westend-testnet) (Polkadot's test network).
...
staking by being a [nominator](../../learn/basics/network-participants/learn-nominator.md) or a member of a
[nomination pool](../../learn/basics/staking/learn-nomination-pools.md). Once you have a funded account, you need to
...
!!!info "The dashboard is a Web3 dApp"
    ...
    to the world of [true Web3](../../learn/general/web3-and-polkadot.md)!
...
- **Section C: The Stats Panel** shows the general view of current staking metrics, including the historical reward rate (including after
  [inflation](../../learn/basics/token-and-assets/learn-inflation.md)), the supply staked and time remaining
  in the current era.
...
- **Section E: The Balance Panel** shows the bonded amount distinguishing between "Nominating", "In
  ...
  on-chain, see [existential deposit](../../learn/basics/accounts/index.md#existential-deposit-and-reaping)).
...
- **Section C: The Pool Panel** shows the pool id where you have membership (in this case, Pool 82),
  ...
  options:
    ...
    - Update Claim Permissions: you can allow other pool members to compound your rewards, withdraw your rewards as a free balance, or both. More details about nomination pools and updating claim permissions can be found on the [dedicated wiki page](../../learn/basics/staking/learn-nomination-pools.md#claim-permissions).
    ...
    [dedicated wiki page](../../learn/basics/staking/learn-nomination-pools.md#pool-commissions).
...
- **Section A: The Stats Panel** shows the number of active nominators,
  ...
  [bags list](../../learn/advanced/learn-staking-advanced.md#bags-list). The fact that active nominators are not
...
light clients for a true Web3 experience. For more information about light clients, see [this page](../../learn/general/web3-and-polkadot.md#decentralized-access-points).
