...
dedicated to native non-custodial [staking](../../learn/basics/staking/learn-staking.md) on the relay chain. The
dashboard allows to stake as a solo nominator or as a
[nomination pool](../../learn/basics/staking/learn-nomination-pools.md) member. Users can also create their nomination
...
supports [staking proxies](../../learn/basics/staking/learn-staking.md#stash-account-and-staking-proxy).
